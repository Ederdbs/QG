# Benchmark of diversity metrics for hybrid selection via DE, at the production
# scale in sim_config. This is the script that produces the numeric results
# quoted in README.md, and the only place the three plot_* helpers are exercised.
#
# Run from the repository root:  Rscript inst/scripts/run_benchmark.R
